...
export default function QuizResultPage() {
  ...
  if (question === undefined) {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center gap-4 px-6 text-center">
        <p className="text-body-medium text-muted">Memuat hasil…</p>
      </main>
    );
  }
  ...
  if (!question) {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center gap-4 px-6 text-center">
        <p className="text-body-medium text-muted">Hasil tidak ditemukan.</p>
  ...
  return (
    <main className="flex min-h-screen flex-col gap-6 px-5 pb-10 pt-5">
      <div className="relative flex items-center justify-center">
        ...
        <h1 className="text-[19px] font-extrabold text-ink">Hasil Kuis</h1>
      </div>
      ...
      <h2 className="text-center text-[21px] font-extrabold text-ink">
        {isMatch ? "Jawaban Kalian Cocok!" : "Jawaban Kalian Beda-beda!"}
      </h2>
      ...
      <div className="flex flex-col gap-3">
        <div className="relative overflow-hidden rounded-[24px] bg-coral p-5">
          ...
          <p className="text-[12.5px] font-bold text-ink/85">JAWABANMU</p>
        ...
        <div className="relative overflow-hidden rounded-[24px] bg-periwinkle p-5">
          <div className="absolute -right-8 -top-8 h-[120px] w-[120px] rounded-full bg-white/10" />
          <p className="text-[12.5px] font-bold text-ink/85">JAWABAN SAYANG</p>
          <p className="mt-1 text-[16px] font-extrabold text-white">
      ...
      {nextQuestionId ? (
        <button
          ...
          className="flex h-16 w-full items-center justify-center rounded-[32px] bg-ink text-[14.5px] font-bold text-white shadow-[0px_8px_20px_0px_rgba(26,13,26,0.28)]"
        >
