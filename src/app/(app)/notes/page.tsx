...
export default function NotesHubPage() {
  ...
  return (
    <main className="flex flex-col gap-6 px-5 pt-7">
      ...
      {status === "loading" && (
        <p className="text-caption text-muted">Memuat…</p>
      )}
      {status === "error" && (
        <p className="text-caption text-error">
          Gagal memuat. Coba muat ulang halaman.
        </p>
      )}
      ...
      {status === "ready" && (
        <>
          <section className="flex flex-col gap-3">
            <p className="text-[13.5px] font-bold text-subtle">PESAN HARI INI</p>
            ...
            {fromPartner ? (
              ...
              <Link
                href="/notes/compose"
                className="flex h-[100px] w-full items-center justify-center rounded-[26px] border-[1.5px] border-dashed border-divider bg-white"
              >
            ...
            {myReply && (
              <div className="h-[100px] w-full rounded-[26px] border-[1.5px] border-divider bg-white p-4 shadow-[0px_6px_18px_0px_rgba(77,51,77,0.1)]">
                <p className="text-[14px] font-bold text-ink">Balasan kamu</p>
          ...
          <section className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              <p className="text-[13.5px] font-bold text-subtle">KUIS UNTUK KAMU</p>
            ...
            {questions.map((q, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-1 text-[13px] font-semibold text-ink/85">
                    {answered ? "Sudah dijawab" : "Ketuk untuk jawab"}
                  </p>
                </Link>
              );
            })}
